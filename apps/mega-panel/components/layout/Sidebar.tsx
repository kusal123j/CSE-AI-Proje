...
const navItems = [
  ...
  { href: '/company-profiles', label: 'Company Intelligence', icon: '▤' },
  { href: '/latest-prices', label: 'Latest Prices', icon: '₨' },
  { href: '/company-financial-reports', label: 'Financial Reports', icon: '◫' },
  { href: '/company-announcements', label: 'Announcements', icon: '!' },
